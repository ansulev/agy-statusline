...
def main():
    ...
    if os.path.exists(settings_path):
        try:
            with open(settings_path, "r") as f:
                ...
                # Separators
                custom_seps = settings.get("statusLine", {}).get("separators", {})
                ...
                custom_pricing = settings.get("statusLine", {}).get("pricing", {})
                ...
                custom_caps = settings.get("statusLine", {}).get("caps", {})
                ...
                custom_budgets = settings.get("statusLine", {}).get("budgets", {})
    ...
    # Resolve active rates and tier
    rates = get_rates_for_model(model_id, PRICING)
    tier = "flash"
    matched_tier = None
